...
export function AgentChat({ conversationId, activeFile, workspaceFiles = [], onOpenFolder, onAddFiles, onNewProject, initialPrompt = "", enabledPlugins = [], githubContext = null, onConversationCreated, onReviewFile }: AgentChatProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-background">
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <AnimatePresence initial={false}>
            ...
            >
              ...
              <div className={`text-[13px] max-w-[88%] leading-6 flex flex-col ${
                msg.role === "user"
                  ? "bg-primary text-foreground rounded-xl rounded-br-sm px-3.5 py-2 border border-border"
                ...
                <span className="whitespace-pre-wrap">
                  {msg.content || (isStreaming ? "Analyzing…" : "")}
                             ...
                             {msg.role === "agent" && (
                  <div className="flex items-center gap-2 mt-3 pt-2 border-t border-border opacity-70">
                    <button 
      ...
      {/* Input Area */}
      <div className="px-6 pb-4 pt-2 bg-gradient-to-t from-background via-background to-transparent shrink-0">
        ...
        <form onSubmit={handleSend} className="relative rounded-xl bg-card border border-border focus-within:border-border shadow-lg">
          ...
          {contextMenuOpen && (
            <div className="absolute left-2 bottom-10 z-20 w-52 rounded-lg border border-border bg-muted p-1.5 shadow-2xl">
          ...
          {modelOpen && (
            <div className="absolute left-10 bottom-10 z-20 max-h-72 w-72 overflow-y-auto rounded-lg border border-border bg-muted p-1.5 shadow-2xl">
              <button
                type="button"
